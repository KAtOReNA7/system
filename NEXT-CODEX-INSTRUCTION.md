...
此路径因历史审计合同继续保留，但不再复制当前分数、阶段任务或一次性授权。后续任务
必须从下列当前权威读取状态，不得把本文件中的历史版本当作新授权：
...
历史 PR、B0–B8、C1–C3、局部实验臂和旧状态索引只用于审计追溯。任何训练、候选
开发、private evaluation、provider、数据库、holdout、Canary、release 或 M3
formal 动作，都必须由当前用户任务明确授权。
