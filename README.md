...
| M2 出版行业规模适配 | 首个完整原始候选已冻结并失败（`M2_PUBLISHING_SCALE_CORE_FAIL`）；[条件金额尺度根因审计](docs/analysis/m2-current/M2-publishing-scale-channel-amount-scale-root-cause-audit-v0.1.md)已完成；[起点可见现金锚金额设计](docs/analysis/m2-current/M2-publishing-scale-channel-origin-visible-cash-anchor-preregistration-v0.1.md)已预注册 | 塌缩从 work-balanced `log1p` 经验父层开始；新设计冻结 PSC01 occurrence，只改变条件正金额，但目前只是设计与公共 reference，不是模型或候选 |
...
最新状态以 [M2 当前状态索引 v0.55](docs/analysis/m2-v2/M2-v2-current-state-index-v0.55.md)
...
- [M2 当前状态索引 v0.55](docs/analysis/m2-v2/M2-v2-current-state-index-v0.55.md)
...
3. 再读 [M2 模型目录与成绩总账](docs/analysis/m2-current/M2-model-catalog-and-scorecard-v1.md)，
   理解模型、实验、状态码和当前角色；
4. 最后读 [M2 当前状态索引 v0.55](docs/analysis/m2-v2/M2-v2-current-state-index-v0.55.md)，
   查看最新结论、阻断项和下一步。
...
| 主题 | 当前入口 |
|---|---|
| 最新状态 | [M2 当前状态索引 v0.55](docs/analysis/m2-v2/M2-v2-current-state-index-v0.55.md) |
...
| 出版规模渠道实验 | [开发评价](docs/analysis/m2-current/M2-current-publishing-scale-channel-development-v0.1.md) · [可预测性诊断](docs/analysis/m2-current/M2-current-publishing-scale-channel-forecastability-v0.1.md) · [条件金额尺度根因审计](docs/analysis/m2-current/M2-publishing-scale-channel-amount-scale-root-cause-audit-v0.1.md) · [起点可见现金锚金额预注册](docs/analysis/m2-current/M2-publishing-scale-channel-origin-visible-cash-anchor-preregistration-v0.1.md) |
