...
本 PR 相对 PR #7 merge base 涉及 146 个文件，净变化约 `+2,046 / -3,549`。其中大量删除来自 80 份逐字节相同 migration 副本；正式 migrations、历史报告、seals、PR #7 immutable binding 和 private artifacts 均未删除或改写。
